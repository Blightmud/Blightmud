...
*Checks whether the given word exists in the dictionary. If called before `spellcheck.init` an error will be produced.*
...
*Returns a table of suggested replacements for a misspelled word. If called before `spellcheck.init` an error will be produced.*
...
**Returns** a table array consisting of candidate replacement words, in order of likelihood.
