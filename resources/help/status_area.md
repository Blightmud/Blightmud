...
*Set or get the status area height. The first and last row will always be rendered as bars. But you can still print to these bars. Setting the height to 0 will hide the status area.*
...
*Prints a line to the status area. If you print to a 'bar line' the content will be integrated into the bar. The "(more)" info shown when scrolling will always be allowed to occupy space before your custom line when applicable.*
