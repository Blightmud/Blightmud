...
pub const TIMER_TICK_CALLBACK_TABLE_CORE: &str = "__timer_tick_callback_table_core";
pub const TIMER_TICK_CALLBACK_TABLE: &str = "__timer_tick_callback_table";
...
pub const PROMPT_CURSOR_INDEX: &str = "__prompt_cursor_index";
